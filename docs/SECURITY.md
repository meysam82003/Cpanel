...
- PHP lint and PHPUnit security/unit suites: successful on PHP 8.2, 8.3 and 8.4 in `CI #13` (136 tests, 529 assertions per matrix run, 3 explicit environment skips).
- Rate limiter, Security Center isolation and MariaDB installation security checks: successful in `CI #13`.
...
- Release ZIP secret scan, internal/external checksum and required-file verification: successful; CI package SHA-256 `ee04f6bac7bbfb70d7a959d930e4a7f0f56b300e57659af20d960f81bd68548d`.
